...
class Mascotas(models.Model):
    ...
    usuario_cliente = models.ForeignKey(
        ...
        models.DO_NOTHING,
        db_column="usuario_cliente",
        db_comment="Este campo es una llave forßnea que hace referencia al usuario cliente que posee la mascota. Permite vincular la mascota con el cliente correspondiente en el sistema.",
    )
    nombre = models.CharField(
        max_length=30,
        blank=True,
        null=True,
        db_comment="Este campo es una llave forßnea que almacena el n·mero de cÚdula del cliente. Es ·til para identificar al cliente de manera oficial y asegurar que la mascota pertenece a Úl.",
    )
    fecha_nacimiento = models.DateField(
        blank=True,
        null=True,
        db_comment="Este campo almacena la fecha de nacimiento de la mascota. Es relevante para determinar la edad y estado de salud de la mascota, asÝ como para el seguimiento de su cuidado.",
    )
    especie = models.CharField(
        max_length=30,
        db_comment='Este campo almacena la especie de la mascota (por ejemplo, "Perro", "Gato"). Ayuda a clasificar las mascotas y gestionar su atenci¾n de acuerdo a su especie.',
    )
    raza = models.CharField(
        max_length=30,
        blank=True,
        null=True,
        db_comment='Este campo almacena la raza de la mascota (por ejemplo, "Labrador", "Siames"). Proporciona informaci¾n adicional que puede ser importante para el cuidado y tratamiento especÝfico de la mascota.',
    )
